...
##FIXME - we need to not do TRIGLY and CRCO here as they have many fewer people
## probably we need to merge them in afterwards, keeping all other rows
...
cols = list(DEMO_I=c("RIDAGEYR","RIAGENDR","RIDRETH1","DMDEDUC2","years"), 
            ...
            HDL_I=c("LBDHDD"),HDL_J=c("LBDHDD"),GHB_I="LBXGH",GHB_J="LBXGH",DIQ_I="DIQ010",
            DIQ_J="DIQ010", BMX_I="BMXBMI", BMX_J="BMXBMI"
            )
var2Table = cols[c(1,3,5,7,9,11)]
