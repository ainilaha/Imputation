...
This notebook aims to demonstrate a work procedures of Environment‐Wide Association Study (EnWAS) (shown in Figure-1) that proposed in [Towards a Common Framework to Support Phenotypic Studies in Large Data Sets]().
<center>
![ <em> Figure-1 EnWAS Work Process  </em>](process.png){width=80%}
</center>
...
We are using the [NHANES](https://www.cdc.gov/nchs/nhanes/index.htm) to demonstrate in this notebook, more details about data can be found on [CDC website](https://www.cdc.gov/nchs/nhanes/index.htm). A quick start notebook about accessing the data in our docker database with provided R function shown in [here](https://ccb-hms.github.io/Imputation/6_phonto/quick_start.html).


## Step 2. Identify a response and a set of confounders that will be adjusted for.

#### 1 ) Identify a response, or outcome of interest.
In this demonstration, we choose diastolic [blood pressure](https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/BPX_I.htm#BPXDI1) as the outcome interest, which saved in BPX_* table (eg. BPX, BPX_B,...,BPX_I) in NHANES.
...
We know that gender, age, ethnicity, education and BMI are related to blood pressure, and choose them as the confounders that will be adjusted for blood pressure.
