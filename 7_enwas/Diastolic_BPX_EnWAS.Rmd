...
In NHANES database, the gender(`RIAGENDR`) encode as 1 for male and 2 for female. Similarly, ethnicity (`RIDRETH1`) are also encode as integers (1 to 5); We need to convert those as variables as factors.
...
```{r enwas00forest, fig.cap = "Forest Plot for non tranformation EnWAS", echo=F,warning=F, out.width = '90%',dpi = 200}
...
```{r enwasinv1log, fig.cap = "Multiple Forest Plots", echo=F,warning=F, out.width = '90%',dpi = 200}
...
```{r enwasinv230, fig.cap = "Scatter Plot for EnWAS against EnWAS with INT", warning=FALSE,echo=F, out.width = '90%',dpi = 200}
library(ggrepel)
top_n_diff <- 10
enwas_res |>
