...
The residual of the spline model is significantly smaller than the linear model, which indicates that the spline model performs much better in this case.
