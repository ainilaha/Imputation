...
lm_bmi <- plot_bins(data$BMXBMI, lm_base$residuals,500)
ns_bmi <- plot_bins(data$BMXBMI, ns_base$residuals,500)

ggarrange(lm_bmi,ns_bmi,common.legend = TRUE)

lm_age <- plot_bins(data$RIDAGEYR, lm_base$residuals,500)
ns_age <- plot_bins(data$RIDAGEYR, ns_base$residuals,500)

ggarrange(lm_age,ns_age,common.legend = TRUE)
```