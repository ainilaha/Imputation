...
# BPXDI2,BPXSY1
blood_pressure <- dbGetQuery(nhanes_db, "select SEQN,(BPXDI1+BPXDI2)/2 AS DIASTOLIC from BloodPressure where BPXDI1 IS NOT NULL and BPXDI1 <> 0 AND BPXDI2 IS NOT NULL and BPXDI2 <> 0")
dbDisconnect(nhanes_db)
