...
nhanes_db <- dbConnect(RSQLite::SQLite(), "../../nhanes.sqlite")
# BPXDI2,BPXSY1
blood_pressure <- dbGetQuery(nhanes_db, "select SEQN,BPXDI2,years from blood_pressure where BPXDI2 IS NOT NULL and BPXDI2 <> 0")
dbDisconnect(nhanes_db)
...
lm_str <- 'BPXDI2 ~ RIDAGEYR*RIAGENDR + BMXBMI'
