...
```{r phonto}
cols = list(DEMO_I=c("RIDAGEYR","RIAGENDR","RIDRETH1","DMDEDUC2","years","INDFMPIR"), 
...
hypertensiveMeds[data$BPQ040A==2] = 2
...
```{r EDA}
  ...
  plot_bins(base_df$DIASTOLIC,base_df$INDFMPIR,nbin =400, title="Diastolic vs Poverty")
