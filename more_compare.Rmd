...
for (i in 1:10){
  ...
  g1 <- qplot(data$wgt[miss_index],impt_mice_data[[3]]$wgt[miss_index],col=sex)+stat_smooth()+ylim(-10, 125)+
    ylab("mice wgt") + xlab("data wgt")+theme(legend.position = "top")
  
  g2 <- qplot(data$wgt[miss_index],impt_ranger_data[[3]]$wgt[miss_index],col=sex)+stat_smooth()+ylim(-10, 125)+
    ylab("ranger wgt") + xlab("data wgt")+theme(legend.position = "top")
  
  g3 <- qplot(data$wgt[miss_index],impt_rmidas_data[[3]]$wgt[miss_index],col=sex)+stat_smooth()+ylim(-10, 125)+
