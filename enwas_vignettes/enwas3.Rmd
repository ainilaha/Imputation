...
# drop systolic and diastolic blood pressure and waist circumference for now because we are running BPXDI1,BPXDI2.

data <- subset(phs_data$data,select=-c(BPXSY1,BPXSY2,BPXDI1,BPXDI2))
...
ns_str <-
  'BMXWAIST ~ ns(RIDAGEYR, knots = seq(30, 80, by = 10), Boundary.knots=c(20,90)) * RIAGENDR + ns(BMXBMI,knots = c(seq(15, 45, by = 5),seq(45,65,by=10)),Boundary.knots=c(10,75)) + RIDRETH1 + DMDEDUC2+years'
