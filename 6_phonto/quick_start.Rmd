...
```{r}
  cb1 = nhanesCodebook(nh_table = LDLTabs[1], colname = "LBDLDL") ## argument names are confusing, if its easy enough lets make them consistent with the columns names from nhanesSearchVarname() 
  cb1
```
