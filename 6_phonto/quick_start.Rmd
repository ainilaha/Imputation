---
title: "Quick Start"
author: "Laha Ale, Robert Gentleman, and Teresa Filshstein-Sonmez"
...
We can efficiently access NHANES data using the `phonto::nhanes...` set of functions, which are implemented at the SQL level. By simply knowing the name of the data file or table, one can very quickly and efficiently obtain basic information, e.g. column names, dimensions, etc. 
...
In the research data frame, Questionnaire present CDC tables.
